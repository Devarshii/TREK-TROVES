...
$sql="UPDATE TblTourPackages SET PackageName=:pname, PackageType=:ptype, PackageLocation=:plocation, PackagePrice=:pprice, PackageFetures=:pfeatures, PackageDetails=:pdetails, PackageTimings=:packageTimings WHERE PackageId=:pid";
								...
								<div class="form-group">
										...
										<div class="col-sm-8 row">
											...
											<?php for($i = 0; $i < 5; $i++) { ?>
												<div class="col-sm-8">
													<div class="col-sm-6">
														<input type="text" class="form-control1 datepicker" name="startDate[]" placeholder="Start date" value="<?php echo !empty($timings[$i]['startDate']) ? $timings[$i]['startDate'] : "" ?>">
													</div>
													<div class="col-sm-6">
														<input type="text" class="form-control1 datepicker" name="endDate[]" placeholder="End date" value="<?php echo !empty($timings[$i]['endDate']) ? $timings[$i]['endDate'] : "" ?>">
													</div>
												</div>
											<?php } ?>
										</div>
